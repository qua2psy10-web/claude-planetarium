  ...
  return (
    <div className="absolute bottom-4 right-4 z-20 select-none">
      <div className="relative w-20 h-20 bg-black/50 backdrop-blur-sm rounded-full border border-white/20">
        ...
        <span className="absolute bottom-1 left-1/2 -translate-x-1/2 text-xs text-white/70">S</span>
        <span className="absolute left-1 top-1/2 -translate-y-1/2 text-xs text-white/70">W</span>
        <span className="absolute right-1 top-1/2 -translate-y-1/2 text-xs text-white/70">E</span>
        {/* Inner ring */}
